...
# clang stuff
		...
		git clone --depth=1 -b release/14.x https://gitlab.com/GhostMaster69-dev/cosmic-clang.git "$HOME"/clang
...
"
        ...
        if [ -f "$IMG" ]; then
                ...
                tg_sticker "CAACAgUAAxkBAAGhC7Vj5-8pxRyUwC3hE8sZKaWs3PiywQACZwIAAn4mCVS1pXdx3_CJ3S4E"
